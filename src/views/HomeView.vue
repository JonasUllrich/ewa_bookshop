...
<template>
  <header class="relative bg-neutral">
    <nav aria-label="Top" class="max-w-[90rem] mx-auto sm:px-6 lg:px-8">
      <div
        class="relative border-b border-[#8620a5] px-20 pb-14 sm:static sm:px-0 sm:pb-0"
      >
        <div class="h-20 flex items-center justify-between">
          ...
          <div class="flex-1 flex items-center justify-end">
            ...
            <input
              ...
              type="text"
              name="search"
              class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-64 pr-12 sm:text-sm border-gray-500 text-sm text-transparent bg-clip-text bg-gradient-to-r from-[#fdfdfd] to-[#e546d0] rounded-md"
              placeholder="Suche"
...
const products: Array<TProduct> = [
  ...
  },
  {
    ...
    LinkGrafik:
      "https://d2sofvawe08yqg.cloudfront.net/accessible-vue/s_hero2x?1620623767",
  },
  {
    ProduktID: 3,
    ...
    Lagerbestand: 10,
    LinkGrafik:
      "https://javascriptbook.com/images/book/javascript-and-jquery-book-cover.png",
  },
  {
    ProduktID: 4,
  ...
  },
  {
    ...
    Lagerbestand: 2,
    LinkGrafik:
      "https://www.lapabooks.com/assets/images/the-modern-web-design-process.png",
  },
];
// const v = [
//  https://ph-files.imgix.net/55f4cce3-a55a-4de7-8dff-d943819fcd56.png?auto=format&auto=compress&codec=mozjpeg&cs=strip
